...
Grammer.prototype.first = function (s, k) {
  ...
  for (var i = 0; i < symbols.length; i++) {
    if ([].indexOf.call(this.tokens, symbols[i]) > -1) {
      ...
      var r2 = this.firstOfSymbol(symbols[i], k);
